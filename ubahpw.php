...
<main class="form-signin mt-5">
  <form method="post" action="">
    ...
    <p><small>Reset password disini.</small></p>
    ...
    <a class = "w-100 btn btn-lg btn-danger mt-2" href="login.php" style="text-decoration: none; color: white;"><p class="h5 mx-auto">Batal</p></a>
